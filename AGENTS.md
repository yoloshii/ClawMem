...
| `CLAWMEM_EMBED_MAX_CHARS` | `4000` | Max chars per embedding input. Default fits EmbeddingGemma (2048 tokens). Set to `1100` for granite-278m (512 tokens). Cloud providers skip truncation. |
