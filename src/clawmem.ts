...
async function cmdSetupOpenClaw(args: string[]) {
  ...
  console.log();
  console.log(`  3. Restart OpenClaw so the new plugin is discovered:`);
  console.log(`     ${c.cyan}openclaw gateway restart${c.reset}`);
  console.log();
  console.log(`  4. Set ClawMem as the active context engine:`);
  console.log(`     ${c.cyan}openclaw config set plugins.slots.contextEngine clawmem${c.reset}`);
  console.log();
  console.log(`  5. Configure GPU endpoints (if not using defaults):`);
  ...
  console.log();
  console.log(`  6. Start the REST API (for tool calls):`);
